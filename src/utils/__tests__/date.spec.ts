...
describe("getShiftedWeekdays", () => {
  ...
  it("should shift weekdays correctly when weekStartDay is 0", () => {
    expect(getShiftedWeekdays(weekdays, 0)).toEqual([
      "Sunday",
      "Monday",
      "Tuesday",
      "Wednesday",
  ...
  it("should shift weekdays correctly when weekStartDay is 3", () => {
    expect(getShiftedWeekdays(weekdays, 3)).toEqual([
      "Wednesday",
      "Thursday",
      "Friday",
      "Saturday",
  ...
  it("should shift weekdays correctly when weekStartDay is 6", () => {
    expect(getShiftedWeekdays(weekdays, 6)).toEqual([
      "Saturday",
      "Sunday",
      "Monday",
      "Tuesday",
  ...
  it("should work with non-standard weekday arrays", () => {
    ...
    expect(getShiftedWeekdays(customWeekdays, 2)).toEqual([
      "Wed",
      "Thu",
      "Fri",
      "Mon",
  ...
  it("should handle duplicate values in the weekdays array", () => {
    ...
    expect(getShiftedWeekdays(duplicateWeekdays, 1)).toEqual([
      "Sun",
      "Mon",
      "Tue",
      "Sun",
...
function withFakeNow(
  fakeNow: { local: [number, number, number]; utc: [number, number, number] },
  run: () => void,
) {
...
describe("resolveDateRange", () => {
  ...
  it("returns null when nothing is set", () => {
    expect(
      resolveDateRange(undefined, undefined, undefined, undefined),
    ).toBeNull();
  });
  ...
  it("ignores an inverted startDate/endDate pair", () => {
    expect(
      resolveDateRange("2025-02-01", "2025-01-01", undefined, undefined),
    ).toBeNull();
  });
